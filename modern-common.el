...
(defun create-modern-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;                   ~~ Dark ~~                              ~~ Light ~~
            ...
            (bg2           (pcase variant ('dawn (if (true-color-p) "#132632" "#1c1c1c")) ('dark (if (true-color-p) "#222222" "#1c1c1c")) ('light (if (true-color-p) "#FFFEFC" "#e4e4e4"))))
            (bg3           (pcase variant ('dawn (if (true-color-p) "#18303F" "#121212")) ('dark (if (true-color-p) "#333333" "#121212")) ('light (if (true-color-p) "#CCCCCC" "#d0d0d0"))))
            (bg4           (pcase variant ('dawn (if (true-color-p) "#214054" "#080808")) ('dark (if (true-color-p) "#444444" "#080808")) ('light (if (true-color-p) "#999999" "#bcbcbc"))))
            ...
            (cursor        (pcase variant ('dawn (if (true-color-p) "#648DFF" "#d0d0d0")) ('dark (if (true-color-p) "#e3dedd" "#d0d0d0")) ('light (if (true-color-p) "#100a14" "#121212"))))
            ...
            (comp          (pcase variant ('dawn (if (true-color-p) "#D87184" "#d75fd7")) ('dark (if (true-color-p) "#8CB6E1" "#d75fd7")) ('light (if (true-color-p) "#53B9E5" "#8700af"))))
            ...
            (ttip-sl       (pcase variant ('dawn (if (true-color-p) "#C79C77" "#333333")) ('dark (if (true-color-p) "#5E7998" "#333333")) ('light (if (true-color-p) "#73B3FF" "#afafff"))))
            (ttip-bg       (pcase variant ('dawn (if (true-color-p) "#4E3824" "#444444")) ('dark (if (true-color-p) "#202933" "#444444")) ('light (if (true-color-p) "#D1E6FF" "#dfdfff"))))
            ...
            (aqua-l        (pcase variant ('dawn (if (true-color-p) "#C79C77" "#2aa198")) ('dark (if (true-color-p) "#80CABF" "#2aa198")) ('light (if (true-color-p) "#3F8E95" "#2aa198"))))
            (aqua-d        (pcase variant ('dawn (if (true-color-p) "#F1AD4D" "#2aa198")) ('dark (if (true-color-p) "#80CABF" "#2aa198")) ('light (if (true-color-p) "#3F8E95" "#2aa198"))))
            ...
            (green-l       (pcase variant ('dawn (if (true-color-p) "#7FB087" "#67b11d")) ('dark (if (true-color-p) "#CFD838" "#67b11d")) ('light (if (true-color-p) "#768F00" "#5faf00"))))
            (green-d       (pcase variant ('dawn (if (true-color-p) "#96F591" "#67b11d")) ('dark (if (true-color-p) "#CFD838" "#67b11d")) ('light (if (true-color-p) "#768F00" "#5faf00"))))
            (green-bg      (pcase variant ('dawn (if (true-color-p) "#233C2E" "#262626")) ('dark (if (true-color-p) "#66622C" "#262626")) ('light (if (true-color-p) "#F2FFB6" "#ffffff"))))
            (green-bg-s    (pcase variant ('dawn (if (true-color-p) "#14221A" "#262626")) ('dark (if (true-color-p) "#716D30" "#262626")) ('light (if (true-color-p) "#ECFF92" "#ffffff"))))
            (red           (pcase variant ('dawn (if (true-color-p) "#D87184" "#d70000")) ('dark (if (true-color-p) "#DC6864" "#d70000")) ('light (if (true-color-p) "#D43D34" "#d70008"))))
            (red-l         (pcase variant ('dawn (if (true-color-p) "#BB7B86" "#d70000")) ('dark (if (true-color-p) "#DC6864" "#d70000")) ('light (if (true-color-p) "#D43D34" "#d70008"))))
            (red-d         (pcase variant ('dawn (if (true-color-p) "#E46261" "#d70000")) ('dark (if (true-color-p) "#DC6864" "#d70000")) ('light (if (true-color-p) "#D43D34" "#d70008"))))
            ...
            (blue-d        (pcase variant ('dawn (if (true-color-p) "#648DFF" "#268bd2")) ('dark (if (true-color-p) "#1E95CC" "#268bd2")) ('light (if (true-color-p) "#195FB1" "#268bd2"))))
            ...
            (magenta-l     (pcase variant ('dawn (if (true-color-p) "#837EB9" "#af00df")) ('dark (if (true-color-p) "#C3A1D2" "#af00df")) ('light (if (true-color-p) "#9E6FB8" "#800080"))))
            (magenta-d     (pcase variant ('dawn (if (true-color-p) "#9C75ED" "#af00df")) ('dark (if (true-color-p) "#C3A1D2" "#af00df")) ('light (if (true-color-p) "#9E6FB8" "#800080"))))
            ...
            (yellow        (pcase variant ('dawn (if (true-color-p) "#FFED6A" "#875f00")) ('dark (if (true-color-p) "#FFC65D" "#875f00")) ('light (if (true-color-p) "#C27200" "#875f00"))))
            (yellow-l      (pcase variant ('dawn (if (true-color-p) "#EADC77" "#875f00")) ('dark (if (true-color-p) "#FFC65D" "#875f00")) ('light (if (true-color-p) "#C27200" "#875f00"))))
            (yellow-d      (pcase variant ('dawn (if (true-color-p) "#FFDA53" "#875f00")) ('dark (if (true-color-p) "#FFC65D" "#875f00")) ('light (if (true-color-p) "#C27200" "#875f00"))))
            (yellow-bg     (pcase variant ('dawn (if (true-color-p) "#575124" "#262626")) ('dark (if (true-color-p) "#3F3116" "#262626")) ('light (if (true-color-p) "#FFE3BD" "#ffffff"))))
            )
...
;;;;; Outline
            `(outline-1                              ((,class (:foreground ,yellow-d  :weight ultra-bold :italic t :underline t))))
            ...
            `(outline-5                              ((,class (:foreground ,yellow-l  :weight bold :italic t))))
...
;;;;; org
            ...
            `(org-level-1                            ((,class (:foreground ,yellow-d  :weight ultra-bold :height ,(if modern-theme-org-height 1     . 3 1.0) :slant italic :background ,(when modern-theme-org-highlight yellow-bg)))))
            ...
            `(org-level-5                            ((,class (:foreground ,yellow-l  :weight bold :slant italic))))
            ...
            `(org-level-8                            ((,class (:foreground ,green-l   :weight bold :slant italic))))
