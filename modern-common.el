...
;;;;; doom-emacs
   `(doom-modeline-eldoc-bar                 ((,class (:inherit unspecified :foreground ,yellow ))))
   `(doom-modeline-warning                   ((,class (:inherit unspecified :foreground ,orange))))
   `(doom-modeline-buffer-major-mode         ((,class (:inherit unspecified :foreground ,aqua :weight bold))))
   `(doom-modeline-bar                       ((,class (:inherit unspecified :background ,blue))))
   `(doom-modeline-inactive-bar              ((,class (:inherit unspecified :background ,blue-bg))))
   `(doom-modeline-buffer-modified           ((,class (:inherit unspecified :foreground ,orange :weight bold))))
   `(doom-modeline-buffer-path               ((,class (:inherit unspecified :foreground ,aqua :weight bold))))
   `(doom-modeline-urgent                    ((,class (:inherit unspecified :foreground ,yellow :weight bold))))
   `(doom-modeline-info                      ((,class (:inherit unspecified :foreground ,green :weight bold))))
   `(doom-modeline-highlight                 ((,class (:inherit unspecified :background ,blue :weight bold))))
   `(doom-modeline-buffer-file               ((,class (:inherit unspecified :foreground ,blue :weight bold))))
   `(doom-modeline-panel                     ((,class (:inherit unspecified :foreground ,base1 :background ,blue))))
   `(doom-modeline-error                     ((,class (:inherit unspecified :foreground ,base1 :background ,red :distant-foreground ,red))))
