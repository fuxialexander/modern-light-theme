...
;;;;; org
            `(org-agenda-clocking           ((,class (:family "fira code" :background ,highlight :foreground ,comp))))
            `(org-agenda-date               ((,class (:family "fira code" :foreground ,var :height ,(if modern-theme-org-agenda-height 1.1 1.0)))))
            `(org-agenda-date-today         ((,class (:family "fira code" :foreground ,keyword :inherit bold :height ,(if modern-theme-org-agenda-height 1.3 1.0)))))
            `(org-agenda-date-weekend       ((,class (:family "fira code" :foreground ,var))))
            `(org-agenda-done               ((,class (:family "fira code" :foreground ,base-dim :height ,(if modern-theme-org-agenda-height 1.2 1.0)))))
            `(org-agenda-structure          ((,class (:family "fira code" :inherit bold :overline t :underline t :slant italic :foreground ,comp))))

            `(org-habit-clear-face          ((,class (:family "fira code" :background ,bg4 ))))
            `(org-habit-clear-future-face   ((,class (:family "fira code" :background ,bg3 ))))
            `(org-habit-ready-face          ((,class (:family "fira code" :background ,blue ))))
            `(org-habit-ready-future-face   ((,class (:family "fira code" :background ,blue-bg ))))
            `(org-habit-alert-face          ((,class (:family "fira code" :background ,yellow ))))
            `(org-habit-alert-future-face   ((,class (:family "fira code" :background ,yellow-bg ))))
            `(org-habit-overdue-face        ((,class (:family "fira code" :background ,red ))))
            `(org-habit-overdue-future-face ((,class (:family "fira code" :background ,red-bg ))))

            `(org-block                              ((,class (:family "fira code" :background ,cblk-bg :foreground ,cblk))))
            `(org-block-begin-line                   ((,class (:family "fira code" :background ,cblk-ln-bg :foreground ,cblk-ln))))
            `(org-block-end-line                     ((,class (:family "fira code" :background ,cblk-ln-bg :foreground ,cblk-ln))))
            `(org-clock-overlay                      ((,class (:family "fira code" :foreground ,comp))))
            `(org-code                               ((,class (:family "fira code" :foreground ,blue-l :height 1.0))))
            `(org-column                             ((,class (:family "fira code" :foreground ,red))))
            `(org-column-title                       ((,class (:family "fira code" :background ,highlight))))
            `(org-date                               ((,class (:family "fira code" :underline t :weight normal :foreground ,var))))
            `(org-date-selected                      ((,class (:family "fira code" :background ,func :foreground ,bg1))))
            `(org-document-info-keyword              ((,class (:family "fira code" :foreground ,meta))))
            ...
            `(org-kbd                                ((,class (:family "fira code" :inherit region :foreground ,base :box (:line-width 1 :style released-button)))))
            ...
            `(org-level-5                            ((,class (:family "charter" :foreground ,blue-l  :weight bold :slant italic))))
            `(org-level-6                            ((,class (:family "charter" :foreground ,magenta-l :weight bold :slant italic))))
            `(org-level-7                            ((,class (:family "charter" :foreground ,red-l     :weight bold :slant italic))))
            `(org-level-8                            ((,class (:family "charter" :foreground ,green-l   :weight bold :slant italic))))
            `(org-link                               ((,class (:family "fira code" :underline t))))
            `(org-meta-line                          ((,class (:family "fira code" :foreground ,meta))))
            `(org-mode-line-clock-overrun            ((,class (:foreground ,err))))
            `(org-priority                           ((,class (:family "fira code" :foreground ,war :height 0.85 :inherit bold))))
            `(org-quote                              ((,class (:family "fira code" :inherit org-block :slant italic))))
            `(org-scheduled                          ((,class (:family "fira code" :inherit org-level-3 :foreground ,comp))))
            `(org-scheduled-today                    ((,class (:family "fira code" :inherit org-level-3 :foreground ,func :height ,(if modern-theme-org-agenda-height 1.2 1.0)))))
            `(org-scheduled-previously               ((,class (:family "fira code" :inherit org-level-3 :foreground ,func :height ,(if modern-theme-org-agenda-height 1.2 1.0)))))
            `(org-sexp-date                          ((,class (:family "fira code" :foreground ,base))))
            `(org-special-keyword                    ((,class (:family "fira code" :foreground ,func))))
            `(org-tag                                ((,class (:family "fira code" :slant italic :weight bold :foreground ,aqua))))
            `(org-table                              ((,class (:family "fira code" :foreground ,red ))))
            `(org-time-grid                          ((,class (:family "fira code" :foreground ,str))))
            `(org-todo                               ((,class (:family "fira code" :foreground ,war :inherit bold :background ,yellow-bg))))
            `(org-verbatim                           ((,class (:family "fira code" :foreground ,keyword))))
