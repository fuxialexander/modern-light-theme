...
;;;;; doom-line
            `(doom-modeline-buffer-path              ((,class (:foreground ,aqua :bold t  :family "SF UI Display"))))
            `(doom-modeline-project-root-dir         ((,class (:foreground ,aqua :bold t  :family "SF UI Display"))))
            `(doom-modeline-buffer-file              ((,class (:foreground ,blue :bold t  :family "SF UI Display"))))
            `(doom-modeline-buffer-modified          ((,class (:foreground ,red :bold t  :family "SF UI Display"))))
            `(doom-modeline-buffer-major-mode        ((,class (:foreground ,blue :bold t  :family "SF UI Display"))))
            `(doom-modeline-highlight                ((,class (:background ,blue :bold t  :family "SF UI Display"))))
            `(doom-modeline-panel                    ((,class (:background ,blue :foreground ,bg1 :bold t  :family "SF UI Display"))))
            ;; `(doom-modeline-info                  ((,class (  :family "SF UI Display"))))
            `(doom-modeline-perspname                ((,class (:foreground ,magenta :bold t  :family "SF UI Display"))))
            `(doom-modeline-workspace-number         ((,class (:foreground ,magenta :weight normal  :family "SF UI Display"))))
            `(doom-modeline-info                     ((,class (:bold t :foreground ,green-d  :family "SF UI Display"))))
            `(doom-modeline-warning                  ((,class (:bold t :foreground ,yellow-d  :family "SF UI Display"))))
            `(doom-modeline-urgent                   ((,class (:bold t :foreground ,red-d  :family "SF UI Display"))))

            `(mode-line                              ((,class (:foreground ,base :weight bold :background ,act1  :family "SF UI Display"))))
            `(mode-line-buffer-id                    ((,class (:inherit bold :foreground ,func  :family "SF UI Display"))))
            `(mode-line-inactive                     ((,class (:foreground ,base-dim :weight bold :background ,act1  :family "SF UI Display"))))
            `(mode-line-highlight                    ((,class (:background ,act1 :foreground ,base :weight bold  :family "SF UI Display"))))
