...
;;;;; doom-line
            `(doom-modeline-buffer-path              ((,class (:foreground ,aqua :bold t  :family "input mono condensed"))))
            `(doom-modeline-project-root-dir         ((,class (:foreground ,aqua :bold t  :family "input mono condensed"))))
            `(doom-modeline-buffer-file              ((,class (:foreground ,blue :bold t  :family "input mono condensed"))))
            `(doom-modeline-buffer-modified          ((,class (:foreground ,red :bold t  :family "input mono condensed"))))
            `(doom-modeline-buffer-major-mode        ((,class (:foreground ,blue :bold t  :family "input mono condensed"))))
            `(doom-modeline-highlight                ((,class (:background ,blue :bold t  :family "input mono condensed"))))
            `(doom-modeline-panel                    ((,class (:background ,blue :foreground ,bg1 :bold t  :family "input mono condensed"))))
            ;; `(doom-modeline-info                  ((,class (  :family "input mono condensed"))))
            `(doom-modeline-perspname                ((,class (:foreground ,magenta :bold t  :family "input mono condensed"))))
            `(doom-modeline-workspace-number         ((,class (:foreground ,magenta :weight normal  :family "input mono condensed"))))
            `(doom-modeline-info                     ((,class (:bold t :foreground ,green-d  :family "input mono condensed"))))
            `(doom-modeline-warning                  ((,class (:bold t :foreground ,yellow-d  :family "input mono condensed"))))
            `(doom-modeline-urgent                   ((,class (:bold t :foreground ,red-d  :family "input mono condensed"))))

            `(mode-line                              ((,class (:foreground ,base :weight bold :background ,act1  :family "input mono condensed"))))
            `(mode-line-buffer-id                    ((,class (:inherit bold :foreground ,func  :family "input mono condensed"))))
            `(mode-line-inactive                     ((,class (:foreground ,base-dim :weight bold :background ,act1  :family "input mono condensed"))))
            `(mode-line-highlight                    ((,class (:background ,act1 :foreground ,base :weight bold  :family "input mono condensed"))))
...
;;;;; org
            ...
            `(org-scheduled                          ((,class (:family "operator mono" :inherit org-level-3 :foreground ,comp))))
            `(org-scheduled-today                    ((,class (:family "operator mono" :inherit org-level-3 :foreground ,func :height ,(if modern-theme-org-agenda-height 1.2 1.0)))))
