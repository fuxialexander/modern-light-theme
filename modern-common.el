...
;;;;; org
            ...
            `(org-date                               ((,class (:family "operator mono" :underline nil :weight bold :italic t :foreground ,yellow-d :background ,yellow-bg))))
            `(org-date-selected                      ((,class (:family "operator mono" :weight bold :italic t :background ,yellow-bg :foreground ,yellow-d))))
