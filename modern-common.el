...
;;;;; doom-line
            `(doom-modeline-buffer-path              ((,class (:family "Sf Compact Display" :foreground ,aqua :bold t  ))))
            `(doom-modeline-project-root-dir         ((,class (:family "Sf Compact Display" :foreground ,aqua :bold t  ))))
            `(doom-modeline-buffer-file              ((,class (:family "Sf Compact Display" :foreground ,blue :bold t  ))))
            `(doom-modeline-buffer-modified          ((,class (:family "Sf Compact Display" :foreground ,magenta :bold t  ))))
            `(doom-modeline-buffer-major-mode        ((,class (:family "Sf Compact Display" :foreground ,blue :bold t  ))))
            `(doom-modeline-highlight                ((,class (:family "Sf Compact Display" :background ,blue :bold t  ))))
            `(doom-modeline-panel                    ((,class (:family "Sf Compact Display" :background ,blue :foreground ,bg1 :bold t  ))))
            `(doom-modeline-perspname                ((,class (:family "Sf Compact Display" :foreground ,magenta :bold t  ))))
            `(doom-modeline-workspace-number         ((,class (:family "Sf Compact Display" :foreground ,violet :weight normal  ))))
            `(doom-modeline-workspace-number-inactive         ((,class (:family "Sf Compact Display" :foreground ,base1 :weight normal  ))))
            `(doom-modeline-info                     ((,class (:family "Sf Compact Display" :bold t :foreground ,green))))
            `(doom-modeline-warning                  ((,class (:family "Sf Compact Display" :bold t :foreground ,yellow))))
            `(doom-modeline-urgent                   ((,class (:family "Sf Compact Display" :bold t :foreground ,orange))))

            `(mode-line                              ((,class (:family "Sf Compact Display" :foreground ,base1 :weight bold :background ,act1  ))))
            `(mode-line-buffer-id                    ((,class (:family "Sf Compact Display" :weight bold :foreground ,func  ))))
            `(mode-line-inactive                     ((,class (:family "Sf Compact Display" :foreground ,base2 :weight bold :background ,act1  ))))
            `(mode-line-highlight                    ((,class (:family "Sf Compact Display" :background ,act1 :foreground ,base1 :weight bold  ))))
            `(mode-line-emphasis                    ((,class (:family "Sf Compact Display" :background ,act1 :foreground ,yellow-l :weight bold  ))))

            `(doom-modeline-bar                      ((,class (:family "Sf Compact Display" :background ,blue))))
            ;; `(doom-modeline-eldoc-bar             ((,class ())))
            `(doom-modeline-inactive-bar             ((,class (:family "Sf Compact Display" :background ,blue-l))))
