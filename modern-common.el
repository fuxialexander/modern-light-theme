...
;;;;; doom-emacs
   ...
   `(doom-modeline-warning                   ((,class (:inherit unspecified :slant normal :foreground ,orange))))
   ...
   `(doom-modeline-panel                     ((,class (:inherit unspecified :slant normal :foreground ,base1 :background ,blue))))
