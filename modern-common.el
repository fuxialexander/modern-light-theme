...
;;;;; doom-line
            `(doom-modeline-buffer-path              ((,class (:family "Input Mono Condensed" :foreground ,aqua :bold t  ))))
            `(doom-modeline-project-root-dir         ((,class (:family "Input Mono Condensed" :foreground ,aqua :bold t  ))))
            `(doom-modeline-buffer-file              ((,class (:family "Input Mono Condensed" :foreground ,blue :bold t  ))))
            `(doom-modeline-buffer-modified          ((,class (:family "Input Mono Condensed" :foreground ,magenta :bold t  ))))
            `(doom-modeline-buffer-major-mode        ((,class (:family "Input Mono Condensed" :foreground ,blue :bold t  ))))
            `(doom-modeline-highlight                ((,class (:family "Input Mono Condensed" :background ,blue :bold t  ))))
            ...
            `(mode-line                              ((,class (:family "Input Mono Condensed" :foreground ,base1 :weight bold :background ,act1  ))))
            `(mode-line-buffer-id                    ((,class (:family "Input Mono Condensed" :weight bold :foreground ,func  ))))
            `(mode-line-inactive                     ((,class (:family "Input Mono Condensed" :foreground ,base2 :weight bold :background ,act1  ))))
            `(mode-line-highlight                    ((,class (:family "Input Mono Condensed" :background ,act1 :foreground ,base1 :weight bold  ))))
            `(mode-line-emphasis                    ((,class (:family "Input Mono Condensed" :background ,act1 :foreground ,yellow-l :weight bold  ))))

            `(doom-modeline-bar                      ((,class (:family "Input Mono Condensed" :background ,blue))))
            ;; `(doom-modeline-eldoc-bar             ((,class ())))
            `(doom-modeline-inactive-bar             ((,class (:family "Input Mono Condensed" :background ,blue-l))))
