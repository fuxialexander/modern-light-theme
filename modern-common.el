...
;;;;; org
            ...
            `(org-date                               ((,class (:family "input mono compressed" :underline nil :weight bold :foreground ,bg1 :background ,yellow-bg))))
            `(org-date-selected                      ((,class (:family "operator mono" :background ,yellow-bg :foreground ,yellow-d))))
