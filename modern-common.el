...
;;;;; doom-line
            `(doom-modeline-buffer-path              ((,class (:foreground ,aqua :bold t  :family "Iosevka"))))
            `(doom-modeline-project-root-dir         ((,class (:foreground ,aqua :bold t  :family "Iosevka"))))
            `(doom-modeline-buffer-file              ((,class (:foreground ,blue :bold t  :family "Iosevka"))))
            `(doom-modeline-buffer-modified          ((,class (:foreground ,red :bold t  :family "Iosevka"))))
            `(doom-modeline-buffer-major-mode        ((,class (:foreground ,blue :bold t  :family "Iosevka"))))
            `(doom-modeline-highlight                ((,class (:background ,blue :bold t  :family "Iosevka"))))
            `(doom-modeline-panel                    ((,class (:background ,blue :foreground ,bg1 :bold t  :family "Iosevka"))))
            ;; `(doom-modeline-info                  ((,class (  :family "Iosevka"))))
            `(doom-modeline-perspname                ((,class (:foreground ,magenta :bold t  :family "Iosevka"))))
            `(doom-modeline-workspace-number         ((,class (:foreground ,magenta :weight normal  :family "Iosevka"))))
            `(doom-modeline-info                     ((,class (:bold t :foreground ,green-d  :family "Iosevka"))))
            `(doom-modeline-warning                  ((,class (:bold t :foreground ,yellow-d  :family "Iosevka"))))
            `(doom-modeline-urgent                   ((,class (:bold t :foreground ,red-d  :family "Iosevka"))))

            `(mode-line                              ((,class (:foreground ,base :weight bold :background ,act1  :family "Iosevka"))))
            `(mode-line-buffer-id                    ((,class (:inherit bold :foreground ,func  :family "Iosevka"))))
            `(mode-line-inactive                     ((,class (:foreground ,base-dim :weight bold :background ,act1  :family "Iosevka"))))
            `(mode-line-highlight                    ((,class (:background ,act1 :foreground ,base :weight bold  :family "Iosevka"))))
