...
(defun create-modern-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;                   ~~ Dark ~~                              ~~ Light ~~
            ...
            (cblk-bg       (if (eq variant 'dark) (if (true-color-p) "#0F1319" "#262626") (if (true-color-p) "#FFEEEE" "#ffffff")))
            (cblk-ln       (if (eq variant 'dark) (if (true-color-p) "#9BA3A6" "#af5faf") (if (true-color-p) "#60605F" "#af5fdf")))
            (cblk-ln-bg    (if (eq variant 'dark) (if (true-color-p) "#1A212A" "#333333") (if (true-color-p) "#F2D3CF" "#dfdfff")))
            ...
            (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#0B0908" "#262626") (if (true-color-p) "#F2EDED" "#ffffff")))
            ...
            (str           (if (eq variant 'dark) (if (true-color-p) "#2d9574" "#2aa198") (if (true-color-p) "#0019D5" "#2aa198")))
            (suc           (if (eq variant 'dark) (if (true-color-p) "#E5FF6D" "#86dc2f") (if (true-color-p) "#A9CC00" "#00af00")))
            (ttip          (if (eq variant 'dark) (if (true-color-p) "#3F5266" "#888888") (if (true-color-p) "#357797" "#5f5f87")))
            ...
            (blue          (if (eq variant 'dark) (if (true-color-p) "#4AA5CC" "#268bd2") (if (true-color-p) "#195FB1" "#268bd2")))
            ...
            (magenta-bg    (if (eq variant 'dark) (if (true-color-p) "#5E4A68" "#af00df") (if (true-color-p) "#EED3FF" "#800080")))
