...
;;;;; doom-line
            `(doom-modeline-buffer-path              ((,class (:foreground ,aqua :bold t :height 1.2 :family "input mono condensed"))))
            `(doom-modeline-project-root-dir         ((,class (:foreground ,aqua :bold t :height 1.2 :family "input mono condensed"))))
            `(doom-modeline-buffer-file              ((,class (:foreground ,blue :bold t :height 1.2 :family "input mono condensed"))))
            `(doom-modeline-buffer-modified          ((,class (:foreground ,red :bold t :height 1.2 :family "input mono condensed"))))
            `(doom-modeline-buffer-major-mode        ((,class (:foreground ,blue :bold t :height 1.2 :family "input mono condensed"))))
            `(doom-modeline-highlight                ((,class (:background ,blue :bold t :height 1.2 :family "input mono condensed"))))
            `(doom-modeline-panel                    ((,class (:background ,blue :foreground ,bg1 :bold t :height 1.2 :family "input mono condensed"))))
            ;; `(doom-modeline-info                  ((,class ( :height 1.2 :family "input mono condensed"))))
            `(doom-modeline-perspname                ((,class (:foreground ,magenta :bold t :height 1.2 :family "input mono condensed"))))
            `(doom-modeline-workspace-number         ((,class (:foreground ,magenta :weight normal :height 1.2 :family "input mono condensed"))))
            `(doom-modeline-info                     ((,class (:bold t :foreground ,green-d :height 1.2 :family "input mono condensed"))))
