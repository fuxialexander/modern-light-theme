...
;;;;; doom-emacs
   `(doom-modeline-eldoc-bar                 ((,class (:inherit nil :foreground ,yellow ))))
   `(doom-modeline-warning                   ((,class (:inherit nil :foreground ,orange))))
   `(doom-modeline-buffer-major-mode         ((,class (:inherit nil :foreground ,aqua :weight bold))))
   `(doom-modeline-bar                       ((,class (:inherit nil :background ,blue))))
   `(doom-modeline-inactive-bar              ((,class (:inherit nil :background ,blue-bg))))
   `(doom-modeline-buffer-modified           ((,class (:inherit nil :foreground ,orange :weight bold))))
   `(doom-modeline-buffer-path               ((,class (:inherit nil :foreground ,aqua :weight bold))))
   `(doom-modeline-urgent                    ((,class (:inherit nil :foreground ,yellow :weight bold))))
   `(doom-modeline-info                      ((,class (:inherit nil :foreground ,green :weight bold))))
   `(doom-modeline-highlight                 ((,class (:inherit nil :background ,blue :weight bold))))
   `(doom-modeline-buffer-file               ((,class (:inherit nil :foreground ,blue :weight bold))))
   `(doom-modeline-panel                     ((,class (:inherit nil :foreground ,base1 :background ,blue))))
   `(doom-modeline-error                     ((,class (:inherit nil :foreground ,base1 :background ,red :distant-foreground ,red))))
