...
(defun create-modern-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;                   ~~ Dark ~~                              ~~ Light ~~
            ;;                                                          GUI       TER                           GUI       TER
            ;; generic
            (act1          (if (eq variant 'dark) (if (true-color-p) "#333332" "#121212") (if (true-color-p) "#EAEAEB" "#d7dfff")))
            (act2          (if (eq variant 'dark) (if (true-color-p) "#333332" "#444444") (if (true-color-p) "#EAEAEB" "#afafd7")))
            ...
            (bg1           (if (eq variant 'dark) (if (true-color-p) "#000000" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
            ...
            (cblk-bg       (if (eq variant 'dark) (if (true-color-p) "#161C25" "#262626") (if (true-color-p) "#FFEEEE" "#ffffff")))
            (cblk-ln       (if (eq variant 'dark) (if (true-color-p) "#9BA3A6" "#af5faf") (if (true-color-p) "#60605F" "#af5fdf")))
            (cblk-ln-bg    (if (eq variant 'dark) (if (true-color-p) "#283542" "#333333") (if (true-color-p) "#F2D3CF" "#dfdfff")))
            ...
            (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#2F2723" "#262626") (if (true-color-p) "#F2EDED" "#ffffff")))
            ...
            (mat           (if (eq variant 'dark) (if (true-color-p) "#CFD838" "#86dc2f") (if (true-color-p) "#C73930" "#af005f")))
            (meta          (if (eq variant 'dark) (if (true-color-p) "#535356" "#af875f") (if (true-color-p) "#D5D5D8" "#df5f5f")))
            (str           (if (eq variant 'dark) (if (true-color-p) "#428EE9" "#2aa198") (if (true-color-p) "#0019D5" "#2aa198")))
            (suc           (if (eq variant 'dark) (if (true-color-p) "#D9F267" "#86dc2f") (if (true-color-p) "#A9CC00" "#00af00")))
            (ttip          (if (eq variant 'dark) (if (true-color-p) "#77A2C6" "#888888") (if (true-color-p) "#357797" "#5f5f87")))
            (ttip-sl       (if (eq variant 'dark) (if (true-color-p) "#5E7998" "#333333") (if (true-color-p) "#73B3FF" "#afafff")))
            (ttip-bg       (if (eq variant 'dark) (if (true-color-p) "#202933" "#444444") (if (true-color-p) "#D1E6FF" "#dfdfff")))
            (type          (if (eq variant 'dark) (if (true-color-p) "#FF7974" "#df005f") (if (true-color-p) "#C73930" "#af005f")))
            (var           (if (eq variant 'dark) (if (true-color-p) "#7EA5CC" "#8787d7") (if (true-color-p) "#9367AB" "#af5fd7")))
            (war           (if (eq variant 'dark) (if (true-color-p) "#ED9E56" "#dc752f") (if (true-color-p) "#B66900" "#dc752f")))

            ;; colors
            (aqua          (if (eq variant 'dark) (if (true-color-p) "#80CABF" "#2aa198") (if (true-color-p) "#3F8E95" "#2aa198")))
            (aqua-bg       (if (eq variant 'dark) (if (true-color-p) "#2F3C4C" "#262626") (if (true-color-p) "#D5FCFF" "#ffffff")))
            (green         (if (eq variant 'dark) (if (true-color-p) "#CFD838" "#67b11d") (if (true-color-p) "#768F00" "#5faf00")))
            (green-bg      (if (eq variant 'dark) (if (true-color-p) "#66622C" "#262626") (if (true-color-p) "#F2FFB6" "#ffffff")))
            (green-bg-s    (if (eq variant 'dark) (if (true-color-p) "#716D30" "#262626") (if (true-color-p) "#ECFF92" "#ffffff")))
            (cyan          (if (eq variant 'dark) (if (true-color-p) "#8CB6E1" "#00ffff") (if (true-color-p) "#2D87B1" "#008080")))
            (red           (if (eq variant 'dark) (if (true-color-p) "#DC6864" "#d70000") (if (true-color-p) "#D43D34" "#d70008")))
            (red-bg        (if (eq variant 'dark) (if (true-color-p) "#3F1D1C" "#262626") (if (true-color-p) "#FFE5E4" "#ffffff")))
            (red-bg-s      (if (eq variant 'dark) (if (true-color-p) "#572926" "#262626") (if (true-color-p) "#FFD2D0" "#ffffff")))
            (blue          (if (eq variant 'dark) (if (true-color-p) "#1E95CC" "#268bd2") (if (true-color-p) "#195FB1" "#268bd2")))
            (blue-bg       (if (eq variant 'dark) (if (true-color-p) "#16313F" "#262626") (if (true-color-p) "#D7E9FF" "#d7d7ff")))
            (magenta       (if (eq variant 'dark) (if (true-color-p) "#C3A1D2" "#af00df") (if (true-color-p) "#9E6FB8" "#800080")))
            (magenta-bg    (if (eq variant 'dark) (if (true-color-p) "#3A2E41" "#af00df") (if (true-color-p) "#EED3FF" "#800080")))
            (yellow        (if (eq variant 'dark) (if (true-color-p) "#FFC65D" "#875f00") (if (true-color-p) "#C27200" "#875f00")))
            (yellow-bg     (if (eq variant 'dark) (if (true-color-p) "#3F3116" "#262626") (if (true-color-p) "#FFE3BD" "#ffffff")))
            )
