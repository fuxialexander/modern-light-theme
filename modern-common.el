...
;;;;; org
            ...
            `(org-level-1                            ((,class (:family "charter" :foreground ,blue-d  :weight ultra-bold :height ,(if modern-theme-org-height 1.6 1.0) :slant italic :background ,(when modern-theme-org-highlight blue-bg)))))
            `(org-level-2                            ((,class (:family "charter" :foreground ,magenta-d :weight extra-bold :height ,(if modern-theme-org-height 1.4 1.0) :slant italic :background ,(when modern-theme-org-highlight magenta-bg)))))
            `(org-level-3                            ((,class (:family "charter" :foreground ,red-d     :weight bold :height ,(if modern-theme-org-height 1.2 1.0) :slant italic :background ,(when modern-theme-org-highlight red-bg)))))
