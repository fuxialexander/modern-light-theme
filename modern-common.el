...
;;;;; org
   ...
   `(org-block-begin-line                    ((,class (:foreground ,cblk-ln :weight ultra-light :slant italic))))
   `(org-block-end-line                      ((,class (:foreground ,cblk-ln :weight ultra-light :slant italic))))
