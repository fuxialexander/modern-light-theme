...
;;;;; org
            ...
            `(org-level-1                            ((,class (:family "operator ssm" :foreground ,blue  :weight ultra-bold :height ,(if modern-theme-org-height 1.3 1.0) :slant italic :background ,(when modern-theme-org-highlight blue-bg)))))
            `(org-level-2                            ((,class (:family "operator ssm" :foreground ,green :weight extra-bold :height ,(if modern-theme-org-height 1.2 1.0) :slant italic :background ,(when modern-theme-org-highlight magenta-bg)))))
            `(org-level-3                            ((,class (:family "operator ssm" :foreground ,violet     :weight bold :height ,(if modern-theme-org-height 1.1 1.0) :slant italic :background ,(when modern-theme-org-highlight red-bg)))))
            `(org-level-4                            ((,class (:family "operator ssm" :foreground ,magenta   :weight bold :slant italic :background ,(when modern-theme-org-highlight green-bg)))))
            `(org-level-5                            ((,class (:family "operator ssm" :foreground ,blue-d  :weight bold :slant italic))))
            `(org-level-6                            ((,class (:family "operator ssm" :foreground ,green-d :weight bold :slant italic))))
            `(org-level-7                            ((,class (:family "operator ssm" :foreground ,violet-d     :weight bold :slant italic))))
            `(org-level-8                            ((,class (:family "operator ssm" :foreground ,magenta-d   :weight bold :slant italic))))
